    ...
    #EXPONENTIATION // #DEEP_DUP // #FIBONACCI // #BINARY_SEARCH
    #MERGE_SORT // #ARRAY_SUBSETS // #PERMUTATIONS // #MAKE_CHANGE
    ...
    class Array
        ...
        def dd_map 
            map { |el| el.is_a?(Array) ? el.dd_map : ele }
        end
    end
    ...
    class Array
        ...
        def merge(left, right)
            ...
            until left.empty? || right.empty?
                merged_array << (left.first < right.first) ? left.shift : right_shift
            end
    ...
    def make_change(target, coins = [25, 10, 5, 1])
        ...
        coins.each_with_index do |coin, index|
            ...
            next if best_remainder.nil? || (this_change.count < best_change.count)
